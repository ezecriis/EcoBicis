...
<head>
  ...
  <title>West Ecobicis - Remover</title>
        ...
        <div class="login-leters">
          <div class="row">
            ...
            <div class="col-5 p-4 border border-warning" id="nuevoCliente">
              ...
              <form action="../web/pass_recu2.php" method="post">
                ...
                <br />
                <div class="form-group">
                  <button class="btn btn-success btn-sm btn-block" type="submit" name="enviar" id="enviar">Recuperar</button>
                </div>
              </form>
              <br>
              <br>
              ...
              if (isset($_GET['error']) == 1) {
                echo "<div class='alert alert-danger' role='alert'>Correo inválido.</div>";
              }
              ?>
            </div>
