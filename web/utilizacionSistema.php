...
<head>
    ...
    <title>West Ecobicis - Utilizacion del sistema</title>
            ...
            <nav class="nav-menu float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down"><a href="#">Login</a>
                        <ul>
                            <li><a href="registro.php">Registrarce</a></li>
    ...
    <main id="main">
        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Utilizacion del sistema</h2>
                    <ol>
                        <li><a href="../index.php">Inicio</a></li>
                        <li>Utilizacion del sistema</li>
                    </ol>
                </div>
        ...
        <section class="about" data-aos="fade-up">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <img src="../assets/img/coffee-bike.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <h3>Es muy simple utilizar nuestros servicios !</h3>
                        <p class="font-italic">
                            <br />
                        </p>
                        <ul>
                            <li><i class="icofont-check-circled"></i> Simplemente registrate en ecobicis.</li>
                            <li><i class="icofont-check-circled"></i> Completa el formulario <a href="registro.php">aqui</a> con tus datos, logueate.</li>
                            <li><i class="icofont-check-circled"></i> Y ya podes comenzar a pedalear una vida mas sana !</li>
                        </ul>
                        <p>
                            Con el fin de no dañar el planeta tierra, comenzamos a emprender este pequeño cambio para la sociedad,
