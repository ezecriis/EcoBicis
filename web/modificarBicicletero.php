    ...
    <main id="main">
        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Modificar Bicicletero</h2>
                    <ol>
                        <li><a href="../index.php">Inicio</a></li>
                        <li>Modificar bicicletero</li>
                    </ol>
                </div>
        ...
        <div class="register">
            <div class="container">
                ...
                <?php
                $_SESSION['id_estacion'] = $id;

                $conexion = new PDO("mysql:host=localhost; dbname=ecobicis", "root", "");
                $conexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                $conexion->exec("SET CHARACTER SET UTF8");

                $sql = "SELECT estaciones.estacion, bicicletero.direccion, bicicletero.disponibles, bicicletero.stock, bicicletero.estado, bicicletero.id FROM estaciones INNER JOIN bicicletero ON estaciones.id_estacion = bicicletero.fk_estacion && bicicletero.id = $id";
                        ...
                        <div class="col-5 p-4 border border-warning" id="nuevoCliente">
                            ...
                            <form action="../web/modificarBicicletero2.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="direccion" disabled required value="<?php echo $filas['direccion'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Disponibles:</label>
                                    <input class="form-control" type="text" name="disponibles" required value="<?php echo $filas['disponibles'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Stock:</label>
