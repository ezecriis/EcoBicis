            ...
            <nav class="nav-menu float-right d-none d-lg-block">
                <ul>
                    ...
                    <li><a href="../contact.php">Contacto</a></li>
                     <?php
                          if (!empty($_SESSION['admin']) == 2) {
                            echo "<li class='drop-down'><a href='#'>" . $_SESSION['nombre'] . "</a>";
                            echo "<ul>";
                            echo "<li><a href='web/edit_usu.php'>Mi Cuenta</a></li>";
                            ...
                            echo "</ul>";
                            echo "</li>";
                          } elseif(!empty($_SESSION['admin']) == 1) {
                            echo "<li class='drop-down'><a href='#'>" . $_SESSION['nombre'] . "</a>";
                            echo "<ul>";
                            echo "<li><a href='web/micuenta.php'>Usuarios</a></li>";
                            echo "<li><a href='web/reserva.php'>Bicicletas</a></li>";
                            echo "<li><a href='web/historial.php'>Historial Reservas</a></li>";
                            echo "<li><a href='web/logout.php'>Cerrar sesion</a></li>";
                            echo "</ul>";
                            echo "</li>";
                          }else{
                ...
                <div class="register-leters">
                    <div class="row">
                        ...
                        <div class="col-5 p-4 border border-warning" id="nuevoCliente">
                            ...
                            <form action="../web/edit_usu2.php" method="post">
                                <div class="form-group">
                                    <label>Nombre:</label>
                                    <input class="form-control" type="text" name="nombre" maxlength="25" required value="<?php echo $_SESSION['nombre'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Apellido:</label>
                                    <input class="form-control" type="text" name="apellido" maxlength="30" required value="<?php echo $_SESSION['apellido'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Email:</label>
                                    <input class="form-control" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" name="email" maxlength="40" required value="<?php echo $_SESSION['email'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Telefono:</label>
                                    <input class="form-control" type="number" name="telefono" maxlength="20" required value="<?php echo $_SESSION['telefono'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>CUIL:</label>
                                    <input class="form-control" type="number" name="cuil" maxlength="11" required readonly value="<?php echo $_SESSION['cuil'] ?>">
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-primary btn-sm btn-block" type="submit" name="enviar" id="enviar">Confirmar</button>
                                </div>
                                <div class="form-check-label">
                                    <a href="../web/edit_pass.php" class="navbar navbar-light bg-light justify-content-center">Cambiar contraseña</a>
                                </div>
                            </form>
                            <?php
                                include("correo.php");
